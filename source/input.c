...
int input_get_guess(double *xguess,
  ...
  for (index_guess=0; index_guess < pfzw->target_size; index_guess++) {
    ...
    case Omega_scf:
      if (POTENTIALTYPE==0){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = (1.6e-8/pow(ba.scf_parameters[0]*ba.scf_parameters[1],2))/( pow(1.-ba.Omega0_scf,2)*sqrt(1.- pow(1. - (1.6e-8/pow(ba.scf_parameters[0]*ba.scf_parameters[1],2))*(ba.Omega0_scf/(1-ba.Omega0_scf)),2)));
          }
          if (ba.scf_tuning_index == 0){
              xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
              dxdy[index_guess] = (1./(2.*ba.scf_parameters[1]))*sqrt( (1.6e-8/(1. - cos(ba.scf_parameters[ba.scf_parameters_size-2]/ba.scf_parameters[1]))  )/(ba.Omega0_scf*pow(1.-ba.Omega0_scf,3.)));
          }
      }
      if (POTENTIALTYPE==1){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = (1.6e-8*ba.scf_parameters[1]/pow(ba.scf_parameters[0],4))/pow(1.-ba.Omega0_scf,2);
          }
      }
      if (POTENTIALTYPE==2){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = -(1.6e-8*ba.scf_parameters[1]*pow(ba.scf_parameters[0],4))/(pow(1.-ba.Omega0_scf,2)*(1.6e-8*ba.Omega0_scf/(1-ba.Omega0_scf)));
      ...
      if (POTENTIALTYPE==3){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = -(1.6e-8*ba.scf_parameters[1]/pow(ba.scf_parameters[0],4))/(pow(1.-ba.Omega0_scf,2)*(1.5707963268+1.6e-8*ba.Omega0_scf/((1-ba.Omega0_scf)*pow(ba.scf_parameters[0],4))));
          //ignoring the velocity
          }
      }
      if (POTENTIALTYPE==4){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = -(pow(ba.scf_parameters[0],4)*ba.scf_parameters[1]/1.6e-8)/pow(ba.Omega0_scf,2);
          }
      }
      if (POTENTIALTYPE==5){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = ((0.5*ba.scf_parameters[1]*(1.6e-8)/(pow(ba.scf_parameters[0],4)*pow(1.-ba.Omega0_scf,2)))*1./sqrt(log(1.6e-8*ba.Omega0_scf/(pow(ba.scf_parameters[0],4)*(1.-ba.Omega0_scf)) +1.)))*1./((1.6e-8*ba.Omega0_scf/(pow(ba.scf_parameters[0],4)*(1.-ba.Omega0_scf)) +1. ));
          }
      }
      if (POTENTIALTYPE==6){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = -((0.5*ba.scf_parameters[1]*(1.6e-8)/(pow(ba.scf_parameters[0],4)*pow(1.-ba.Omega0_scf,2)))*1./sqrt(-log(1.6e-8*ba.Omega0_scf/(pow(ba.scf_parameters[0],4)*(1.-ba.Omega0_scf)))))*1./((1.6e-8*ba.Omega0_scf/(pow(ba.scf_parameters[0],4)*(1.-ba.Omega0_scf)) ));
          }
      }
      if (POTENTIALTYPE==20){
          if (ba.scf_tuning_index == ba.scf_parameters_size-1){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          //dxdy[index_guess] = (1e-18)*sqrt(0.8e-8)/sqrt(ba.Omega0_scf*pow(1-ba.Omega0_scf,3));
          dxdy[index_guess] = pow(1e9,2)*sqrt((1.6e-8)/2)/sqrt(ba.Omega0_scf*pow(1-ba.Omega0_scf,3));
          }
      }
      if (POTENTIALTYPE==7){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = (1.6e-8)/(3.*ba.scf_parameters[1]*pow(ba.scf_parameters[0],2))*(1./pow(1-ba.Omega0_scf,2))*pow( ((1.6e-8)/pow(ba.scf_parameters[0]*ba.scf_parameters[1],2))*ba.Omega0_scf/(1.-ba.Omega0_scf)  ,-2./3.)*pow(1.-pow( 1.- pow( ((1.6e-8)/pow(ba.scf_parameters[0]*ba.scf_parameters[1],2))*ba.Omega0_scf/(1.-ba.Omega0_scf) ,1./3.)    ,2),-1./2.)                           ;
          }
      }
      if (POTENTIALTYPE==8){
          if (ba.scf_tuning_index == ba.scf_parameters_size-2){
          xguess[index_guess] = ba.scf_parameters[ba.scf_tuning_index];
          dxdy[index_guess] = (1./ba.scf_parameters[0])*pow(0.8e-8,0.5)*pow(ba.Omega0_scf*pow(1-ba.Omega0_scf,3),-0.5);
          }
      }
      break;
    case omega_ini_dcdm:
...
int input_read_parameters(struct file_content * pfc,
  ...
  /** Define local variables */
  int input_verbose=0;
  ppr->tol_background_integration = 1e-10;
  ppr->background_integration_stepsize = 1e-20;
  if (POTENTIALTYPE == 20){
      ppr->tol_initial_Omega_r = 0.05;
  }
...
int input_read_parameters_species(struct file_content * pfc,
  ...
  class_read_double("a_ini_user",pba->a_ini_user);
  /* Complete set of parameters */
